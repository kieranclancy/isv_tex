...
\makeevenhead{headvref}{}{\thepage}{}
\makeoddhead{headvref}{}{\thepage}{}
\pagestyle{headvref}
...
% formatting
\newcommand{\bookheader}[1]{\thispagestyle{bookstart}}
\newcommand{\labelbook}[1]{}
\newcommand{\bookpretitle}[1]{\vspace{2\baselineskip}\Needspace{0.5\textheight}{\centering \large \textsc{#1} \\}}
\newcommand{\booktitle}[1]{{\centering \Huge \textsc{\textbf{#1}} \par}}
\newlength{\hangvwidth}
\newcommand{\verseone}{}
\renewcommand{\v}[1]{\ifthenelse{\equal{#1}{1}}{\verseone}{\textsuperscript{#1}}}
\makeatletter
\let\old@v\v
...
\newcommand{\passage}[1]{\par\Needspace{3\baselineskip}\vspace{0.2\baselineskip}\noindent\textbf{{\textsf{#1}}~\\}\vspace{-1.0\baselineskip}}
\newcommand{\poempassage}[1]{\par\Needspace{3\baselineskip}\vspace{0.2\baselineskip}\noindent\hspace{-4em}\textbf{\textsf{#1}~\\}\vspace{0.0\baselineskip}}
\newcommand{\chapt}[1]{\lettrine{#1}{}}
\newcommand{\labelchapt}[1]{}
\newcommand{\poeml}{}
\newcommand{\poemll}{\vin}
\newcommand{\poemlll}{\vin\vin}
...
\newcommand{\labelpsalm}[1]{\labelchapt{#1}{\centering \textbf{Psalm~#1} \par}}
