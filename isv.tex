...
\newcommand{\labelbook}[1]{\def\thebook{#1}\def\thechapter{}\def\theverse{}\def\theref{}}
\newcommand{\bookpretitle}[1]{{\centering \large \textsc{#1} \par}\addvspace{-0.6em plus 0.2em}}
\newcommand{\booktitle}[1]{{\centering \Huge \textsc{\textbf{#1}}\par}\addvspace{0.4em plus 0.1em}}
\newlength{\hangvwidth}
\newcommand{\verseone}{}
