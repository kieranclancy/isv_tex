...
\makeevenhead{headvref}{\rightmark}{}{\thetestament}
\makeoddhead{headvref}{\thetestament}{}{\leftmark}
\makeevenfoot{headvref}{}{\thepage}{}\makeoddfoot{headvref}{}{\thepage}{}
\makeoddhead{bookstart}{\def\thepageref{}}{}{}
\makeevenhead{bookstart}{\def\thepageref{}}{}{}
\pagestyle{headvref}
...
% formatting
\newcommand{\bookheader}[1]{\newpage\thispagestyle{bookstart}}
\newcommand{\labelbook}[1]{}
\newcommand{\bookpretitle}[1]{{\centering \large \textsc{#1} \par}\addvspace{-0.6em plus 0.2em}}
\newcommand{\booktitle}[1]{{\centering \Huge
    \textsc{\textbf{#1}}\par}\addvspace{0.4em plus 0.1em}%
  \def\thebook{#1}\def\thechapter{}\def\theverse{}\dev\theref{}%
}
\newlength{\hangvwidth}
\newcommand{\verseone}{}
...
\newcommand{\chapt}[1]{\lettrine{#1}{}\def\thechapter{#1:}}
