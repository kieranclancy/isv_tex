...
\v{4}While he was meeting with them, he ordered them, \red{``Don't leave }\red{Jerusalem}\red{. Instead, wait for what the Father has promised, about which you heard me speak}\red{,} \v{5}\red{because} \red{John baptized with}\fnote{\fbackref{1:5} Or \fbib{in}} \red{water, but you will be baptized with}\fnote{\fbackref{1:5} Or \fbib{in}} \red{the Holy Spirit a few days from now.''}

\v{6}Now those who had gathered together began to ask Jesus,\fnote{\fbackref{1:6} Lit. \fbib{him}} ``Lord, is this the time when you will restore the kingdom to Israel?'' \v{7}He answered them, \red{``It isn}\red{'}\red{t for you to know what times or periods the Father has fixed by his own authority.} \v{8}\red{But you}\red{'}\red{ll receive power when the Holy Spirit comes on you, and you}\red{'}\red{ll be my witnesses in Jerusalem, in all Judea and Samaria, and to the ends of the earth.''}
...
\v{11}The Lord told him, \red{``Get up, go to the street called Straight, and in the home of Judas look for a man from }\red{Tarsus}\red{ named Saul. At this very moment he}\red{'}\red{s praying.} \v{12}\red{He has seen in a vision}\fnote{\fbackref{9:12} Other mss. lack \fbib{in a vision}} \red{a man named Ananias come in and lay his hands on him so he would see again.''}
...
\v{15}But the Lord told him, \red{``Go, }\red{because }\red{he}\red{'}\red{s my chosen instrument to carry my name to}\red{ unbelievers,}\fnote{\fbackref{9:15} Lit. \fbib{gentiles} ; i.e. unbelieving non-Jews}\red{ to their kings, and to the descendants of Israel.} \v{16}\red{since}\red{ I}\red{'}\red{m going to show him how much he must suffer for my name's sake.''}
...
\v{25}When Barnabas and Saul had fulfilled their mission, they returned to\fnote{\fbackref{12:25} Other mss. read \fbib{from}} Jerusalem, bringing with them John who was also called Mark.
\labelchapt{13}
...
``He told me, \red{`I}\red{'}\red{m Jesus from Nazareth,}\fnote{\fbackref{22:8} Or \fbib{Jesus the Nazarene}; the Gk. \fbib{Nazoraios} may be a word play between Heb. \fbib{netser,} meaning \fbib{branch} (cf. Isa 11:1), and the name \fbib{Nazareth.}} \red{whom you are persecuting.'} \v{9}The men who were with me saw the light but didn't understand the voice of the one who was speaking to me.

\v{10}``Then I asked, `What am I to do, Lord?'

``The Lord told me, \red{`Get up and go into }\red{Damascus}\red{, and there you will be told everything you are destined to do.'} \v{11}Since I could not see because of the brightness of the light, the men who were with me took me by the hand and led me into Damascus.
...
\v{17}``Then I returned to Jerusalem. While I was praying in the Temple, I fell into a trance \v{18}and saw the Lord\fnote{\fbackref{22:18} Lit. \fbib{him}} saying to me, \red{`Hurry up and get out of }\red{Jerusalem}\red{ at once, because the people}\fnote{\fbackref{22:18} Lit. \fbib{they}} \red{won't accept your testimony about me.'}
...
\v{21}``Then he told me, \red{`Go, because I}\red{'}\red{ll send you far away to the gentiles.'}''
...
``The Lord answered, \red{`I}\red{'}\red{m Jesus, whom you are persecuting.} \v{16}\red{But get up and stand on your feet, }\red{because}\red{ I}\red{'}\red{ve appeared to you for the very purpose of appointing you to be my servant and witness of what you}\red{'}\red{ve seen and of what I}\red{'}\red{ll show you.} \v{17}\red{I}\red{'}\red{ll continue to rescue you from your people and from the gentiles to whom I}\red{'}\red{m sending you.} \v{18}\red{You will help them understand}\fnote{\fbackref{26:18} Lit. \fbib{will open their eyes}}\red{ and turn them from darkness to light and from Satan's control to God, so that their sins will be forgiven and they will receive a share among those who are sanctified by faith in me.'}
